...
import { LayoutDashboard, Users, Upload, BarChart3, Settings } from "lucide-react"
      ...
      <nav className="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
        ...
        {links.map((link) => {
          ...
          return (
            ...
            >
              <Icon className={`w-5 h-5 transition-colors ${isActive ? "text-blue-600" : "group-hover:text-foreground"}`} />
              {link.label}
            </Link>
          )
        })}
