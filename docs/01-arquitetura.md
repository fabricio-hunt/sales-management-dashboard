...
- `/app/api/admin/import/{vendas,fornecedores,clientes,metas,metas_representante}`: 5 endpoints de importação
  independentes, um por entidade. Ver `03-importacao-excel.md`.
- `/app/assistente` + `/app/api/assistente/chat`: chat de IA (Google Gemini) sobre a documentação do sistema.
  Ver `06-assistente-ia.md`.
...
- `/lib/assistente`: contexto de documentação e client do Gemini usados pelo Assistente IA.
